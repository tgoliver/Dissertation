...
\vspace{1mm}
\begin{tabular}{|p{0.1\linewidth}p{0.35\linewidth}p{0.25\linewidth}p{0.15\linewidth}|}
\hline
...
$\Ret $& Reduced Reynolds& $ReEk^{1/3}$ &$10^{3}-10^{4}$\\
 \hline
\end{tabular}
\caption[Core parameters]{Physical properties of the core and associated non-dimensional values. Adapted from Roberts and King (2013)\citep{pR13}. Estimates for the Nusselt number ($Nu$) vary widely and are therefore not included.}
\label{at:param}
\end{center}
\end{table}
