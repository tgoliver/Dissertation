...
The liquid, outer core of the Earth is composed of molten iron that undergoes vigorous convection and rapid rotation. 
The underlying dynamics are poorly understood and, in the absence of sufficient observational data, we use numerical and mathematical models to investigate this system. 
In this dissertation we present three numerical investigations of fluid processes relevant to the outer core of the Earth.
