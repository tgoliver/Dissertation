...
The simulations are performed with the computational fluid dynamics code \texttt{Nek5000} \citep{nek5000}, which uses the spectral element method \citep{aP84} and therefore easily allows for solving the governing equations in domains with irregular boundaries. 
