...
The dimensional torques required to explain observed \textcolor{\revtxt}{LOD} variations are nearly $10^{18}$ N$\cdot$m\hphantom{.}\citep{pR12}. In dimensional form our scaling becomes 
\begin{equation}	
...
The data required to generate the visualisations are not available because they are too large to store on local machines.
\\
\\
