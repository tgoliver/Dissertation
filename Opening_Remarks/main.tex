...
The core of the Earth begins around $2,890$ km beneath the surface and extends to the center of the planet. The outer two-thirds (extending from $2,890$ km down to about $5,150$ km) makes up the liquid outer core, which is composed primarily of molten iron \citep{lW20}. 
...
A likely candidate is the cooling of the solid inner core, which makes up the innermost structure of the Earth. As it cools, the inner core releases heat and light chemicals into the surrounding outer core. 
%The inner core slowly As the temperature of the inner core drops, the interface between the inner and outer core freezes, releasing latent heat and light elements into the outer core. 
...
Before the advent of high powered computing, it was exceedingly difficult to model the chaotic processes which underpin many geophysical systems.
Even now it remains challenge, and modern efforts utilize state of the art computing resources and often require hundreds to thousands of processors. 
...
We find that topography can dramatically increase convective vigor and we provide scaling results which suggest that topographic torques are sufficiently large to explain variations in the Earth's length of day.
